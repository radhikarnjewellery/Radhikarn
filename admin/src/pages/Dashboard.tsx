    ...
    <div className="space-y-12">
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
        ...
        >
          ...
          <h1 className="text-3xl md:text-5xl font-display uppercase tracking-[0.1em] text-[#F5F5F5] font-black mb-4 flex flex-wrap items-center gap-3 md:gap-6">
            Dashboard <span className="gold-gradient-text italic font-medium lowercase tracking-normal font-cormorant text-[2.5rem] md:text-[3.5rem]">Overview</span>
          </h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
        {cards.map((card, i) => (
          <motion.div
            ...
            className="group relative overflow-hidden glass-card p-6 md:p-10 rounded-3xl"
          >
            ...
            <p className="text-[10px] uppercase tracking-[0.3em] text-[#555] font-black mb-2 md:mb-3">{card.name}</p>
            <h3 className="text-xl md:text-3xl font-display gold-gradient-text font-black leading-none">{card.value}</h3>
          </motion.div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 md:gap-10">
        ...
        <div className="xl:col-span-2 glass-card rounded-3xl p-6 md:p-10 relative overflow-hidden border-[#D4AF37]/10 flex flex-col">
        ...
        <div className="glass-card rounded-3xl p-6 md:p-10 border-[#8B7500]/10 flex flex-col">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 md:gap-10">
        <div className="xl:col-span-2 glass-card rounded-3xl p-6 md:p-10 relative overflow-hidden border-[#D4AF37]/10">
          <div className="flex items-center justify-between mb-10">
             <div className="flex items-center gap-4">
        ...
        <div className="glass-card rounded-3xl p-6 md:p-10 border-[#8B7500]/10 flex flex-col justify-center items-center text-center">
          ...
          {serverDown ? (
            <>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  { icon: Server, label: 'Backend', color: 'text-rk-gold' },
                  { icon: Database, label: 'MongoDB', color: 'text-blue-400' },
                  { icon: Cloud, label: 'Cloudinary', color: 'text-rk-gold' },
                ].map(({ icon: Icon, label, color }) => (
                  <div key={label} className="glass-card rounded-2xl p-6 border-red-500/20 space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3"><Icon size={15} className={color} /><span className="text-[10px] uppercase tracking-widest font-black text-white/50">{label}</span></div>
                      <span className="flex items-center gap-1.5 text-[9px] font-black uppercase text-red-400"><AlertCircle size={11} />Server Down</span>
                    </div>
                    <div>
                      <p className="text-3xl font-mono font-black text-red-400">—</p>
                      <p className="text-[9px] text-white/20 uppercase tracking-widest mt-1">Unreachable</p>
                    </div>
                    <div className="pt-2 border-t border-white/5 text-[9px] text-red-400/50 uppercase tracking-widest font-black">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  { icon: Activity, label: 'Order Breakdown', color: 'text-emerald-400' },
                  { icon: Cpu, label: 'Process Memory', color: 'text-purple-400' },
                ].map(({ icon: Icon, label, color }) => (
                  <div key={label} className="glass-card rounded-2xl p-6 border-red-500/20 space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3"><Icon size={15} className={color} /><span className="text-[10px] uppercase tracking-widest font-black text-white/50">{label}</span></div>
                    ...
                    <p className="text-3xl font-mono font-black text-red-400">—</p>
                    <p className="text-[9px] text-red-400/50 uppercase tracking-widest font-black pt-2 border-t border-white/5">Backend server is not responding</p>
                  </div>
                ))}
              </div>
            </>
